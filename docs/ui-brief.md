...
> Archived design brief. This is the original specification the frontend was generated from.
> It is kept as the reference for intended UI behaviour, data shapes and screen inventory.
...
The brief was deliberately structured to build the product interface and interaction architecture first, leaving clean boundaries for the real market-data, ML, backtesting and AI backend to be connected afterward.
